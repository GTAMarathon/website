  ...
  },
  {
    ...
    content: (
      <div className="relative flex flex-col items-center text-center bottom-[-50px]">
        <AutoTextSize>
          <h1 className="text-[150px] text-gtam-yellow max-xl:text-[84px] font-bebasneue">
            April 13-17
          </h1>
        </AutoTextSize>
        ...
        <div className="w-full max-w-screen-lg text-center xl:text-left">
          ...
          <div className="mt-[100px] max-xl:mt-[70px]">
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="bg-gtam-yellow text-black py-[3px] px-4 font-bold xl:text-[40px] text-[20px] inline-block uppercase font-europagrotesk transition duration-300 ease-in-out hover:bg-white hover:scale-110"
            >
        ...
        <div className="w-full max-w-screen-lg text-right">
          ...
          <div>
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="bg-gtam-yellow text-black py-3 px-6 text-xl inline-block uppercase font-europagrotesk text-[60px] font-black transition duration-300 ease-in-out hover:bg-white hover:scale-110"
              >
                Donate
              </a>
            </div>
    ...
    content: (
      <div className="relative left-[-350px] lg:bottom-[-370px] bottom-[-370px] p-8 section-content mobile-scale px-4">
        <div className="max-lg:text-center max-lg:w-full">
          <h1 className="text-[30px] xl:text-[48px] text-gtam-blue font-bold mb-6 uppercase font-europagrotesk">
            Feel like repping the brand?
          </h1>
